...
describe('NumberSchema', () => {
  it('should be a number', () => {
    ...
    expectEqualTypes<typeof actualNumber, GetType<typeof numberSchema>>(true);
  ...
  it('should not be a number', () => {
    ...
    expectEqualTypes<typeof actualNotNumber, GetType<typeof numberSchema>>(false);
    expect(() => parseSchema(numberSchema, actualNotNumber)).toThrow('Invalid type of data');
  });

  it('should be greater than or equal to 5', () => {
    const numberSchema = V().number().custom(min(5));
    expectEqualTypes<number, GetType<typeof numberSchema>>(true);
  ...
  it('should be less than or equal to 5', () => {
    const numberSchema = V().number().custom(max(5));
    expectEqualTypes<number, GetType<typeof numberSchema>>(true);
  ...
  it('should be greater than 5', () => {
    const numberSchema = V().number().custom(minExcluded(5));
    expectEqualTypes<number, GetType<typeof numberSchema>>(true);
  ...
  it('should be less than 5', () => {
    const numberSchema = V().number().custom(maxExcluded(5));
    expectEqualTypes<number, GetType<typeof numberSchema>>(true);
  ...
  it('should be equal to be positive and equal to 5', () => {
    const numberSchema = V().number().custom(positive()).equalTo(5);
    expectEqualTypes<5, GetType<typeof numberSchema>>(true);
