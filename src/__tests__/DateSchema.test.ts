...
describe('DateSchema', () => {
  ...
  it('should invalidate a date string with an invalid time', () => {
    ...
    expect(() => parseOrFail(dateSchema, new Date('2024-01-11T00:60:00.000Z'))).toThrow(DATE_ERROR_MESSAGE);
  });
  ...
  describe('dateMax', () => {
    ...
    it('should throw BuildSchemaError for an invalid date in the assertion', () => {
      ...
      expect(() => dateMax('invalid-date')).toThrow('Invalid date in Date assertion');
    });
    ...
    it('should have a good dateMax translation key', () => {
